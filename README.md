This is a [Next.js](https://nextjs.org/) project [chakraui](https://v2.chakra-ui.com/getting-started) with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
